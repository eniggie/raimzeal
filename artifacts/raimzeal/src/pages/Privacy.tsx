        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-8 text-sm text-muted-foreground leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li><strong className="text-foreground">Payment information:</strong> when you subscribe to Athlete or Elite plans, payment is processed by Stripe, Inc. We do not store your card number — only a Stripe customer ID and subscription status.</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Process subscription payments and manage your membership tier through Stripe.</li>
